...
\begin{frame}{Probleme (3): Ergänzungen (Auswahl)}
	\begin{itemize}
		\item Bei der Implementierung sind Lücken/Ungenauigkeiten im Entwurf aufgefallen.
		\pause
		\item[$\rightarrow$] es wurden einige Ergänzungen/ Änderungen nötig
		\pause
		\begin{itemize}
			\item Methoden, z.B. cleanUp() in VideoProcessingChain
			\pause
			\item Konstanten/Enumerations für Rückgabewerte oder Parameter, z.B. VideoProcessingChain.Chain, Konstanten im ServerProxy
			\item Parameter, z.B. im Encryption-Modul der App
			\pause
...
\begin{frame}{Erfolge}
	\begin{itemize}
		...
		\begin{itemize}
			...
			\item App-Camera
			\pause
			\item Web-Service VideoProcessingModul
			\pause
			\item Web-Service Server Setup
			\pause
			\item Web-Interface VideoDownload
		\end{itemize}
	\end{itemize}
...
% TODO: Insert Picture App Oberfläche
\end{frame}
